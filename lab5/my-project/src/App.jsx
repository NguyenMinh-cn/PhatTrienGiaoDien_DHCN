...
export default function CalculatorWithReducer() {
    ...
    return (
        <div style={{ textAlign: 'center', marginTop: '20px' }}>
            ...
            <input type="number" value={num1} name="" id="" onChange={(e) => setNum1(Number(e.target.value))} />
            <input type="number" value={num2} name="" id="" onChange={(e) => setNum2(Number(e.target.value))} />
